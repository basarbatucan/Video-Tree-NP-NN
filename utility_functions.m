classdef utility_functions
    ...
    methods (Static)
        ...
        function [new_train_valid_test] = update_train_valid_test(train_valid_test)
            ...
            line([all_train_end_index all_train_end_index], [0 test_end_index], 'Color', 'cyan');
            line([test_end_index test_end_index], [0 test_end_index], 'Color', 'magenta');
        ...
        function hyperparameter_space = generate_hyperparameter_space_Video_Tree_NPNN(parameters)
                                        ...
                                        for i_08=1:n8
                                            for i_09=1:n9
                                                for i_10=1:n10
                                                    ...
                                                    hyperparameter_space{hyper_param_i}.D = D_space(i_09);
                                                    hyperparameter_space{hyper_param_i}.g = g_space(i_10);
