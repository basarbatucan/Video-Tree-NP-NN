...
if hyperparam_number>1
    ...
    for i=1:length(hyperparam_space)
        parfor j=1:cross_val_MC
            ...
            % load the model
            model = Video_Tree_NPNN(eta_init, beta_init, gamma, sigmoid_h, lambda, tree_depth, split_prob, node_loss_constant, D, g, n_features, tfpr, max_x, max_y);
